				...
				<div class="top-menu">
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-extended dropdown-inbox"
							...
							data-close-others="true"> <i class="icon-envelope-open"></i>
						...
						<li class="dropdown dropdown-user"><a href="#"
							...
							data-hover="dropdown" data-close-others="true"> <img alt=""
								class="img-circle"
								src="${url}/admin/layout2/img/avatar3_small.jpg" /> <span
				...
				<div class="page-sidebar navbar-collapse collapse">
					...
					<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu "
						...
						<li class="active open"><a href="javascript:;"> <i
								class="icon-basket"></i> <span class="title">eCommerce</span> <span
								class="selected"></span> <span class="arrow open"></span>
						</a>
							<ul class="sub-menu">
								<li><a href="ecommerce_index.html"> <i
								...
								<li class="active"><a href="ecommerce_products_edit.html">
										<i class="icon-pencil"></i> Product Edit
								</a></li>
							</ul></li>
						<li><a href="javascript:;"> <i class="icon-rocket"></i> <span
							...
							<ul class="sub-menu">
								...
								<li><a href="layout_sidebar_fixed.html"> Sidebar Fixed
										Page</a></li>
								<li><a href="layout_sidebar_closed.html"> Sidebar
										Closed Page</a></li>
								<li><a href="layout_ajax.html"> Content Loading via
										Ajax</a></li>
								<li><a href="layout_disabled_menu.html"> Disabled Menu
										Links</a></li>
								<li><a href="layout_blank_page.html"> Blank Page</a></li>
								<li><a href="layout_fluid_page.html"> Fluid Page</a></li>
								<li><a href="layout_language_bar.html"> Language Switch
										Bar</a></li>
							</ul></li>
						<li><a href="javascript:;"> <i class="icon-diamond"></i>
							...
							<ul class="sub-menu">
								...
								<li><a href="ui_icons.html"> <span
										class="badge badge-roundless badge-danger">new</span>Font
										Icons
								</a></li>
								...
								<li><a href="ui_notific8.html"> Notific8 Notifications</a>
								</li>
								...
								<li><a href="ui_session_timeout.html"> Session Timeout</a>
								</li>
								<li><a href="ui_idle_timeout.html"> User Idle Timeout</a></li>
								<li><a href="ui_modals.html"> Modals</a></li>
								<li><a href="ui_extended_modals.html"> Extended Modals</a>
								</li>
						...
						<li><a href="javascript:;"> <i class="icon-settings"></i>
							...
							<ul class="sub-menu">
								...
								<li><a href="form_fileupload.html"> Multiple File
										Upload</a></li>
						...
						<li><a href="javascript:;"> <i class="icon-briefcase"></i>
							...
							<ul class="sub-menu">
								...
								<li><a href="table_editable.html"> Editable Datatables</a>
								</li>
								<li><a href="table_advanced.html"> Advanced Datatables</a>
								</li>
						...
						<li><a href="javascript:;"> <i class="icon-wallet"></i> <span
							...
							<ul class="sub-menu">
								...
								<li><a href="portlet_draggable.html"> Draggable
										Portlets</a></li>
							</ul></li>
						...
						<li><a href="javascript:;"> <i class="icon-docs"></i> <span
							...
							<ul class="sub-menu">
								<li><a href="page_timeline.html"> <i
										class="icon-paper-plane"></i> <span
										class="badge badge-warning">2</span> New Timeline
								</a></li>
								...
								<li><a href="extra_profile_old.html"> <i
										class="icon-user-following"></i> Old User Profile
								</a></li>
								...
								<li><a href="page_news.html"> <i class="icon-eye"></i>
						...
						<li><a href="javascript:;"> <i class="icon-present"></i>
							...
							<ul class="sub-menu">
								...
								<li><a href="extra_pricing_table.html"> Pricing Tables</a>
								</li>
						...
						<li><a href="javascript:;"> <i class="icon-folder"></i> <span
							...
							<ul class="sub-menu">
								...
								<li><a href="javascript:;"> <i class="icon-globe"></i>
									...
									<ul class="sub-menu">
										<li><a href="#"><i class="icon-tag"></i> Sample Link
												1</a></li>
										<li><a href="#"><i class="icon-pencil"></i> Sample
												Link 1</a></li>
										<li><a href="#"><i class="icon-graph"></i> Sample
												Link 1</a></li>
									</ul></li>
